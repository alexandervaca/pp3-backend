...
//	}
//
//	@Transactional(rollbackFor = { IllegalArgumentException.class, UserDetailServiceImplException.class })
...
//		} else {
//			PermisosEnum permisoEnum = PermisosEnum.valueOf(request.getPermiso());
//			Permiso permiso = permisoRepository.findByDescPermiso(permisoEnum.getRole());
...
//
//	@Transactional(rollbackFor = { IllegalArgumentException.class, UserDetailServiceImplException.class })
//	public boolean habilitarDeshabilitarUsuario(String usuarioId) throws UserDetailServiceImplException {
